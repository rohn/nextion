...
exports.responseCodeMap = exports.eventCodeMap = undefined;
 ...
 * @type {Map}
 */
const eventCodeMap = exports.eventCodeMap = new Map(_fp2.default.toPairs(codes.eventCodes));
 ...
 * @type {Map}
 */
const responseCodeMap = exports.responseCodeMap = new Map(_fp2.default.toPairs(codes.responseCodes));
